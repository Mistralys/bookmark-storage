...
use const BMStorage\Configuration\HOSTNAME_LIVE;
 ...
 * @subpackage Core
 */
class LiveEnvironment extends BaseEnvironmentConfig
{
    public function getID(): string
    {
        return EnvironmentsConfig::ENVIRONMENT_LIVE;
    }
    ...
    {
        $this->environment
            ->requireHostNameContains(HOSTNAME_LIVE)
            ->includeFile($this->configFolder.'/env-live.php');
    }
}
